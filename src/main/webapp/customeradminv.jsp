...
<a href="customeradminv.jsp">List of Customers</a>
         ...
         <li> <a href="Logout"><span></span> Logout</a></li>
	  		...
	  		<br><br>
	  		<b><h3><center> Admin Customer View</center></h3></b><br>
<%
...
<tbody>
<tr>
<td><%=resultSet.getString("cfname") %></td>
<td><%=resultSet.getString("clname") %></td>
<td><%=resultSet.getString("phone") %></td>
<td><%=resultSet.getString("addid") %></td>
<td><a href="updatecustomer.jsp?id=<%=resultSet.getString("custid")%>">update</a>|<a href="delete_update.jsp?id=<%=resultSet.getString("custid")%>">Delete</a></td>
</tr>
</tbody>
<%
}
