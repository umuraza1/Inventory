...
<tr><td colspan="2" font-size="40"><center><b> <h2>Add new Supplier</h2><br></b></center></td></tr>
<tr><td>Supplier First Name</td><td><input type="text" name="supfname" ></td></tr>
<tr><td>Supplier Last Name</td><td><input type="text" name="suplname"></td></tr>
<tr><td>phone</td><td><input type="text" name="phone"></td></tr>
<tr><td>Product Id</td><td><input type="text" name="proid"  value=""></td></tr>
<tr><td>Quantity</td><td><input type="text" name="quantity"></td></tr>
<tr><td>Price</td><td><input type="text" name="price"></td></tr>
<tr><td>Date</td><td><input type="date" name="date"></td></tr>
<tr><td></td><td><input type="submit" name="Suppliers" value="Submit"></td></tr>
</table></div>
</form>
</body>
</html>