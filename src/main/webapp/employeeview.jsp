...
<a href="customeradminv.jsp">List of Customers</a>
          ...
          <li> <a href="Logout"><span></span> Logout</a></li>
	  		...
	  		<br><br>
	  		<b><h3><center> Admin Employee View</center></h3></b><br>
<%
...
<tbody>
<tr>
<td><%=resultSet.getString("empfname") %></td>
<td><%=resultSet.getString("emplname") %></td>
<td><%=resultSet.getString("phone") %></td>
<td><%=resultSet.getString("username") %></td>
<td><%=resultSet.getString("password") %></td>
<td><a href="updateemployee.jsp?id=<%=resultSet.getString("empid")%>">update</a>|<a href="deleteemp.jsp?id=<%=resultSet.getString("empid")%>">Delete</a></td>
</tr>
</tbody>
<%
}
