...
<tr><td colspan="2" font-size="40"><center><b> <h2>Update Employee</h2><br></b></center></td></tr>
<input type="hidden" name="id" value="<%=resultSet.getString("empid") %>">
<tr><td>Employee Id </td><td>
<input type="text" name="id" value="<%=resultSet.getString("empid") %>"></td></tr>
<br>
<tr><td>Employee Last Name:</td><td>
<input type="text" name="empfname" value="<%=resultSet.getString("empfname") %>"></td></tr>
<br>
<tr><td>Employee First Name:</td><td>
<input type="text" name="emplname" value="<%=resultSet.getString("emplname") %>"></td></tr>
<br>
<tr><td>Phone</td><td>
...
<input type="password" name="password" value="<%=resultSet.getString("password") %>"></td></tr>
