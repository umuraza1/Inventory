...
<body>
 ...
 <div class="banner">
	  	...
	  	<div class="navbar"><img alt="" src="images/logo1.png">
	  	   <ul>
	  		<li> <a href="indexforemployee.jsp">Home</a></li>
...
<a href="viewc.jsp">List of Customers</a>
	  ...
	  <form name="form1" method="post" action="Upload" enctype="multipart/form-data"><center> 
	  <div class="form">
	   <table width="100%" heigh="100%">	

<h3>Insert an Image </h3>
<input type="file" name="image"><br><br>
<input type="submit" name="submit" value="Upload"></table></div></center>
</form>
