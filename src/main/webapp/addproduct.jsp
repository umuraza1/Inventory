...
<label for="proname">Product Name</label>
    ...
    <input type="text" id="protype" name="protype" placeholder="product type..">
    <label for="quantity">Quantity</label>
    <input type="text" id="quantity" name="quantity" placeholder="product quantity..">
<label for="price">Price</label>
    <input type="text" id="price" name="price" placeholder="price..">
    <label for="fabricationdate">Fabrication Date</label><br>
    <input type="date" id="fabricationdate" name="fabricationdate" placeholder=".."><br>
    <label for="expireddate">Expired Date</label><br>
    <input type="date" id="expireddate" name="expireddate" placeholder="..">
