...
<form method="post" action="customerupdateprocess.jsp">
<div class="form">
<table width="100%" heigh="100%">
<tr><td colspan="2" font-size="40"><center><b> <h2>Update Customer</h2><br></b></center></td></tr>
<input type="hidden" name="id" value="<%=resultSet.getString("custid") %>">
<tr><td>Customer Id </td><td>
<input type="text" name="id" value="<%=resultSet.getString("custid") %>"></td></tr>
<br>
<tr><td>Customer First Name:</td><td>
<input type="text" name="cfname" value="<%=resultSet.getString("cfname") %>"></td></tr>
<br>
<tr><td>Customer Last Name:</td><td>
<input type="text" name="clname" value="<%=resultSet.getString("clname") %>"></td></tr>
<br>
<tr><td>Phone</td><td>
<input type="text" name="phone" value="<%=resultSet.getString("phone") %>"></td></tr>
<br>
<tr><td>addid</td><td>
<input type="text" name="addid" value="<%=resultSet.getString("addid") %>"></td></tr>
